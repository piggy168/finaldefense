	  ...
	  _createClass(Game, [{
	    ...
	    value: function addUnit(type) {
	      ...
	      if (this.income > type.cost) {
	        ...
	        var option = (0, _merge2.default)({}, { pos: [Game.DIM_X * Math.random() * 0.7 + 60, 548],
	          game: this }, type);
	        var unit = new _unit10.default(option);
	    ...
	    value: function draw(ctx) {
	      ...
	      ctx.fillStyle = "green";
	      ctx.fillRect(265, 527, this.income / 5 * .95, 10);
	      ctx.font = "10px Comic Sans MS";
	      ctx.fillStyle = "yellow";
	      ctx.textAlign = "center";
	      ctx.fillText(Math.floor(this.income), 310, 536);
...
/***/ function(module, exports) {
	...
	tankImg.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928898/tank_lj799j.png';
	var tank1Img = new Image();
	tank1Img.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928897/tank1_y8mvtq.png';
	var tank2Img = new Image();
	tank2Img.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928898/tank2_jzwqnz.png';
	var tank3Img = new Image();
	tank3Img.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928898/tank3_hwwsea.png';
	var eTankImg = new Image();
	eTankImg.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928897/etank_qiqxeq.png';
	var eTank1Img = new Image();
	eTank1Img.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928897/etank1_nlqzij.png';
	var eTank2Img = new Image();
	eTank2Img.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928898/etank2_osyl9n.png';
	var eTank3Img = new Image();
	eTank3Img.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928898/etank3_xmtgtr.png';
	var eTurretImg = new Image();
	eTurretImg.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928898/eturret_aviiwx.png';
	var bulletTankImg = new Image();
	bulletTankImg.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928897/bulletTank_xay5em.png';
	var bulletEnemy = new Image();
	bulletEnemy.src = 'http://res.cloudinary.com/hjsqizwtu/image/upload/v1473928897/ebullet_drskxf.png';
