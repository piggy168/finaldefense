	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function addUnit() {
	      var option = (0, _merge2.default)({}, { pos: [Game.DIM_X * Math.random(), 568],
	        game: this }, stats.tank);
	      var option2 = {
	        side: "player",
	        range: 200,
	        vel: [0, -1],
	      ...
	      var unit = new _unit2.default(option);
	    ...
	    value: function remove(object) {
	      if (object instanceof _bullet2.default) {
	        ...
	        new Audio('sound/SFX_ExplGround.mp3').play();
	  ...
	  _createClass(Base, [{
	    ...
	    value: function draw(ctx) {
	      ...
	      if (this.side === 'player') {
	        ...
	        ctx.drawImage(ebaseImg, this.pos[0] - this.width / 2, this.pos[1] - this.length / 2 + 20);
	      }
	    }
	  }, {
	    key: 'inEnemyRange',
